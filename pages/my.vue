          ...
          <b-col>
            <b-row>
              ...
              <b-col lg="5" class="d-flex flex-column mt-2">
                <h6 class="text-muted">
                  {{ coinName(stakeCoinDenom) }} Balance
                </h6>
      ...
      <b-container>
        <b-navbar toggleable="lg" type="light" class="tool-bar">
          ...
          <b-collapse id="nav-collapse" is-nav>
            <b-navbar-nav>
              <b-nav-item :to="localePath({ name: 'my' })" exact>Balances</b-nav-item>
              <b-nav-item :to="localePath({ name: 'my-offers' })">Offers</b-nav-item>
              <b-nav-item :to="localePath({ name: 'my-bids' })">Bids</b-nav-item>
